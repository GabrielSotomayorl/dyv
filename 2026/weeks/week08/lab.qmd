---
title: "Práctico 4: Descripción de Variables Categóricas: Frecuencias y Gráficos de Barras en R"
subtitle: "Trabajando con la Encuesta Nacional de Empleo (ENE)"
date: "2026-10-19"
lang: es
format:
  html:
...
2.  **Descarga la base de datos** desde el sitio del INE. El archivo está en formato Stata (`.dta`).
    *   [Enlace de descarga: ENE (trimestre más reciente)](https://www.ine.gob.cl/estadisticas-por-tema/mercado-laboral/ocupacion-y-desocupacion)
...
La base de datos está disponible en el sitio del [INE](https://www.ine.gob.cl/estadisticas-por-tema/mercado-laboral/ocupacion-y-desocupacion). Descarga el trimestre más reciente en formato Stata (`.dta`) y guárdalo en tu carpeta `datos`. Luego cárgalo así:
...
**Interpretación:** Esta tabla es una estimación para la población total de Chile. El porcentaje de ocupados corresponde a `r round(tabla_frec_pob$Porcentaje[grepl("Ocupado", tabla_frec_pob$condicion_actividad)][1], 1)`% de la población en edad de trabajar para este trimestre — cifras comparables con las publicaciones oficiales del INE.
...
```{r barplot-base}
#| fig-alt: "Gráfico de barras de R base con la frecuencia muestral (sin ponderar) de la condición de actividad en personas de 15 años o más. Ocupados/as es la categoría más frecuente con 42.987 casos (51,7%), seguida de Fuera de la fuerza de trabajo con 35.981 casos (43,3%) y Desocupados/as con 4.193 casos (5,0%)."
...
```{r barplot-ggplot-simple}
#| fig-alt: "Gráfico de barras de ggplot2 con la estimación poblacional ponderada de la condición de actividad, trimestre febrero-marzo-abril 2026. Ocupados/as es la categoría más alta con cerca de 9,4 millones de personas (56,7%), seguida de Fuera de la fuerza de trabajo con 6,3 millones (37,7%) y Desocupados/as con 0,9 millones (5,7%)."
# Explicación del código:
