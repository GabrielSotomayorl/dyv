...
title: "<font style='font-size:1em;'>🗓️ Semana 02<br/> El rol de la estadística y la programación en la sociología actual</font>"
...
## Repaso de la clase anterior {.smaller}
...
## Repaso rápido: La rueda de la ciencia {.smaller}
...
![](img/rueda.png){fig-alt='Diagrama circular "La rueda de las ciencias" (Wallace, 1971): un ciclo con cuatro etapas conectadas por flechas — Teorías, Hipótesis, Observaciones y Generalizaciones empíricas — que vuelve a Teorías. El lado derecho del círculo (de Teorías a Hipótesis a Observaciones) está etiquetado como Deducción; el lado izquierdo (de Observaciones a Generalizaciones empíricas a Teorías) está etiquetado como Inducción.' fig-align="center" width="700"}
...
## Los datos tienen contexto {.smaller}
...
## Datos sistemáticos vs. anécdotas {.smaller}
...
## El caso de Ann Landers: ¿Por qué los datos importan? {.smaller}
...
## La variación está siempre presente {.smaller}
...
![](img/goldthorpe.png){fig-alt='Fotografía de retrato de John Goldthorpe, hombre mayor de cabello blanco, con blazer oscuro y camisa celeste, sentado con las manos entrelazadas.' fig-align="center" width="400"}

::::
::::::


## La sociología como ciencia de la población (2015)  {.smaller}
...
## El caso: Clase, género y trabajo doméstico {.smaller}
...
## El vacío en la investigación {.smaller}
...
## Expectativas teóricas: 5 hipótesis en competencia {.smaller}
...
## Hipótesis 1 y 2: La perspectiva marxista clásica {.smaller}
...
## Hipótesis 3: La perspectiva de las culturas de clase {.smaller}
...
## Hipótesis 4: La perspectiva del poder de negociación {.smaller}
...
## Hipótesis 5: La perspectiva de la autonomía del género {.smaller}
...
## Primeros resultados: ¿Qué nos dicen los datos? {.smaller}

**Tabla 11.3. Contribución porcentual media del esposo al trabajo doméstico total, según composición de clase de la pareja (solo hogares de doble ingreso)**

<table style="width:100%; border:none;"><tbody><tr>
<td style="vertical-align:top; width:50%; border:none; padding:0 1em 0 0;">
<p><strong>Estados Unidos (N = 537)</strong></p>
<table class="tbl-compact">
<colgroup>
<col style="width:34%"><col style="width:22%"><col style="width:22%"><col style="width:22%">
</colgroup>
<thead>
<tr class="header"><th rowspan="2">Esposa</th><th colspan="3">Esposo</th></tr>
<tr class="header"><th>Autoempl.</th><th>Cl. media</th><th>Cl. obrera</th></tr>
</thead>
<tbody>
<tr class="odd"><td>Autoempleada</td><td>17,1%</td><td>22,8%</td><td>16,1%</td></tr>
<tr class="even"><td>Clase media</td><td>22,8%</td><td>23,9%</td><td>25,5%</td></tr>
<tr class="odd"><td>Clase obrera</td><td>16,1%</td><td>22,3%</td><td>27,1%</td></tr>
</tbody>
</table>
</td>
<td style="vertical-align:top; width:50%; border:none; padding:0 0 0 1em;">
<p><strong>Suecia (N = 641)</strong></p>
<table class="tbl-compact">
<colgroup>
<col style="width:34%"><col style="width:22%"><col style="width:22%"><col style="width:22%">
</colgroup>
...
<tbody>
<tr class="odd"><td>Autoempleada</td><td>16,0%</td><td>25,1%</td><td>19,6%</td></tr>
<tr class="even"><td>Clase media</td><td>25,1%</td><td>32,4%</td><td>27,8%</td></tr>
<tr class="odd"><td>Clase obrera</td><td>19,6%</td><td>25,1%</td><td>28,1%</td></tr>
</tbody>
</table>
</td>
</tr></tbody></table>

En ambos países, el aporte más alto del esposo se da cuando ambos cónyuges son de clase obrera; el hogar de clase media pura muestra la mayor diferencia entre países (23,9% en EE. UU. frente a 32,4% en Suecia).

## Discusión 1: Interpretando las medias {.smaller}
...
## Interpretación de Wright (resultados descriptivos) {.smaller}
...
## Añadiendo controles: ¿Se mantiene el efecto de clase? {.smaller}

El siguiente paso es usar un modelo de regresión (Tobit) para ver si los efectos de clase persisten cuando controlamos por otras variables importantes (educación, edad, horas de trabajo de la esposa, ideología de género, etc.).

**Tabla 11.5. Regresiones Tobit del aporte del esposo al trabajo doméstico** (coeficiente y significancia p, según respuesta de las esposas). La categoría de referencia (omitida) es el hogar de clase media pura.

## Regresión Tobit: modelo sin controles {.smaller}

::: {.tbl-compact}
| Categoría de clase | EE. UU. Coef. (p) | Suecia Coef. (p) |
|---|---:|---:|
| 1. Hogar autoempleado | -1,4 (.77) | -9,5 (.10) |
| 2. Autoempleado + medio | 0,9 (.86) | -7,7 (.17) |
| 3. Autoempleado + obrero | -8,9 (.06) | -7,5 (.14) |
| 5. Esposa media + esposo obrero | -0,6 (.89) | -5,0 (.22) |
| 6. Esposa obrera + esposo medio | -0,3 (.93) | -2,9 (.39) |
| 7. Esposa obrera + esposo obrero | 2,5 (.52) | -0,8 (.82) |
| Educación de la encuestada | 1,0 (.40) | 1,8 (.03) |
| R² (OLS equiv.) | .03 | .06 |
| N | 267 | 297 |
:::


## Regresión Tobit: modelo con controles completos {.smaller}

::: {.tbl-compact}
| Categoría de clase / variable de control | EE. UU. Coef. (p) | Suecia Coef. (p) |
|---|---:|---:|
| 1. Hogar autoempleado | 0,5 (.91) | -10,5 (.04) |
| 2. Autoempleado + medio | 1,7 (.71) | -8,8 (.08) |
| 3. Autoempleado + obrero | -1,4 (.77) | -5,0 (.29) |
| 5. Esposa media + esposo obrero | -3,3 (.46) | -5,9 (.11) |
| 6. Esposa obrera + esposo medio | -0,8 (.83) | -2,4 (.42) |
| 7. Esposa obrera + esposo obrero | 4,3 (.26) | -2,6 (.41) |
| Educación de la encuestada | -0,2 (.86) | 0,5 (.55) |
| Horas de trabajo remunerado (esposa) | 0,4 (.00) | 0,4 (.00) |
| Contribución de la esposa al ingreso | 0,5 (.78) | 3,7 (.002) |
| Ingreso familiar total ($ × 10⁻⁴) | 0,5 (.51) | 0,8 (.28) |
| Ideología de género (encuestada) | 1,2 (.06) | 0,9 (.09) |
| Edad | -0,3 (.03) | -0,2 (.02) |
| Hijos menores de 16 en el hogar (0-1) | -1,4 (.57) | -4,5 (.02) |
| R² (OLS equiv.) | .18 | .28 |
| N | 267 | 297 |
:::


## Discusión 2: Interpretando la regresión {.smaller}
...
## Interpretación de Wright (resultados multivariados) {.smaller}
...
## Conclusiones e implicaciones del estudio {.smaller}
...
## La evolución del análisis de datos en sociología {.smaller}
...
## Ventajas de usar un lenguaje de programación (como R) {.smaller}
...
## Presentación de R y RStudio {.smaller}
...
::::
:::: {.column width="50%"}
![](img/r.jpg){fig-alt='Captura de pantalla de RStudio mostrando un script de R que carga ggplot2 y genera un gráfico de dispersión titulado "Diamond Pricing" (precio versus quilates de diamantes, coloreado por claridad), junto con el panel de consola, el entorno de trabajo y el visor de gráficos.' fig-align="center"}
::::
::::::
...
## La lógica de R: Objetos y funciones {.smaller}
...
## Cierre de la unidad: La estadística como práctica sociológica {.smaller}
