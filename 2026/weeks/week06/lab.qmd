---
title: "Práctico 2: Manipulación de Datos con dplyr: Respondiendo Preguntas con datos sociales"
...
Descarga la base de datos CASEN 2024 desde el sitio del [Observatorio Social del Ministerio de Desarrollo Social y Familia](https://observatorio.ministeriodesarrollosocial.gob.cl/encuesta-casen-2024) y guárdala en tu carpeta `datos`. Luego cárgala con una ruta relativa:
