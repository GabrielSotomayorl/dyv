...
title: "<font style='font-size:1em;'>🗓️ Semana 01<br/> Introducción al Curso</font>"
...
| **Controles (CONT)** | 3 controles individuales (se borra el peor) | 10% |
| **Tareas de R (TAR)** | 4 tareas individuales en R | 10% |
| **Pruebas Solemnes (PS)** | 2 pruebas (05/10 y 07/12) | 50% |
...
## Política de Uso de Inteligencia Artificial {.smaller background-color="white"}

-   **Uso acotado y transparente:** autorizado para usos específicos en las Tareas de R y los Trabajos Prácticos, **excepto en la prueba solemne y el examen**.
-   **Permitido:** depurar código y resolver dudas técnicas de ese tipo.
-   **No permitido:** que la IA redacte la interpretación sociológica de los resultados: esa interpretación debe ser trabajo original de ustedes.
-   Deben declarar el uso de IA en cada evaluación: qué usaron, y confirmar que la interpretación es propia.

Revisa el detalle completo en la [Política de IA](../../ai-policy.qmd) del curso.

## Ejemplo: uso permitido y no permitido {.smaller background-color="white"}

::: {style="font-size: 0.75em;"}
Mi código de `ggplot()` marcaba error, le pedí a la IA que revisara la sintaxis y encontré que faltaba un `+`: **uso permitido**. Después le pedí que redactara qué significa sociológicamente la asimetría del gráfico: **uso no permitido**, esa interpretación la deben escribir ustedes.
:::
...
::: {.columns style="display:flex;flex-wrap:nowrap;align-items:stretch;"}
::: {.column style="box-sizing:border-box;flex:1 1 0;width:31%;border-radius:1em;margin:1%;padding:1%;background-color:#f5f5f5"}
...
::: {.column style="box-sizing:border-box;flex:1 1 0;width:31%;border-radius:1em;margin:1%;padding:1%;background-color:#f5f5f5"}
<figure style="text-align: center;">
    <img src="/figures/people/catalina.jpeg" alt="Foto de Catalina Rojas" role="presentation" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;" class="img-responsive atto_image_button_text-bottom">
    <figcaption style="margin-top: 10px;">
        <strong><span>Catalina Rojas</span></strong>
        <br/> Estudiante de Sociología (UDP) <br>
        📧 <a href="mailto:catalina.rojas5@mail.udp.cl">catalina.rojas5@mail.udp.cl</a>
    </figcaption>
</figure>
:::
:::
...
## Bibliografía Obligatoria (1/2) {.smaller}
...
## Bibliografía Obligatoria (2/2) {.smaller}
...
-   **Wickham, H., Çetinkaya-Rundel, M., & Grolemund, G. (2023).** *R para ciencia de datos* (2ª ed.). Disponible en: <https://davidrsch.github.io/r4ds-es/>
...
**[https://gabrielsotomayorl.github.io/dyv/2026/](https://gabrielsotomayorl.github.io/dyv/2026/){preview-link="true"}**
:::

### 🗣️ Delegado/a de Curso

Las comunicaciones del equipo docente para temas colectivos deberán gestionarse de manera centralizada mediante un delegado o delegada. Esto es particularmente relevante para solicitudes respecto a evaluaciones o cambios de fechas.
...
## Conocimiento Científico: Inducción y Deducción {.smaller}
...
## Reflexividad: El/la Sociólogo/a como Sujeto Situado {.smaller}
...
## El Hecho Social: La Mirada de Durkheim {.smaller}
...
![](img/durkheim.png){fig-alt='Tabla histórica del "Cuadro XVIII" del libro *El Suicidio* de Durkheim (1897): tasas de suicidio por millón de habitantes de cada confesión religiosa (protestante, católica, judía) en distintos países europeos entre 1844 y 1891. En casi todos los casos, la tasa de los protestantes es sustancialmente más alta que la de católicos y judíos.' fig-align="center"}

## El Suicidio {.smaller}

![](img/durkheim2.png){fig-alt='Tabla histórica de *El Suicidio* de Durkheim: tasas de suicidio por cada 100.000 habitantes según sexo, estado civil y grupo de edad. Los hombres no casados (viudos y solteros) presentan tasas mucho más altas que los casados, especialmente en la vejez (333,35 por 100.000 en el grupo de 66 años y más, frente a 9,48 en los casados). Las mujeres, en todas las categorías, tienen tasas mucho más bajas que los hombres.' fig-align="center"}
...
## Los 5 Niveles de una Investigación {.smaller}
...
## Aplicando los 5 Niveles al Estudio de Durkheim {.smaller}
...
## El Proceso de Investigación Social Empírica {.smaller}

![](img/01.png){fig-alt='Diagrama de flujo jerárquico del proceso de investigación social en tres grandes bloques. I. Especificación de la pregunta de investigación: planteamiento del problema, pregunta de investigación, objetivos, relevancias. II. Especificación de la posición teórica: estado del arte, toma de posición, conceptos y dimensiones centrales, hipótesis. III. Especificación de la estrategia metodológica: tipo de estudio, tipo de diseño, estrategia metodológica, técnicas de producción de información, técnicas de análisis de información, muestreo.' fig-align="center" width="800"}
...
## Tres Grandes Enfoques Metodológicos {.smaller}
...
## ¿Qué es Medir en Ciencias Sociales? {.smaller}
...
## La Teoría Representacional de la Medición {.smaller}

Medir es asignar números de forma que **representen fielmente las relaciones empíricas**.
...
## Los Niveles de Medición {.smaller}
...
## Contando Historias Sociológicas con Datos {.smaller}
...
## El Espacio Social (Bourdieu) {.smaller}

::: columns
::: {.column width="70%"}
![](img/bourdieu.jpg){fig-alt='Mapa del espacio social de Bourdieu, con el capital total en el eje vertical (más arriba, menos abajo) y el capital cultural cruzado con el capital económico en el horizontal (capital cultural alto y económico bajo a la izquierda; capital cultural bajo y económico alto a la derecha). Arriba a la izquierda se ubican profesores y artistas, asociados a golf, ajedrez y tenis; abajo a la derecha, obreros y agricultores, asociados a fútbol y vino tinto ordinario. Una línea diagonal punteada separa el "voto a la izquierda" (parte inferior) del "voto a la derecha" (parte superior).' fig-align="center" width="600"}
:::

::: {.column width="30%"}
-   Mapea la estructura de clases combinando riqueza (capital económico) con educación y gustos (capital cultural).
-   La desigualdad es multidimensional y se reproduce a través de estilos de vida y prácticas culturales.
:::
:::

## La Desigualdad de Ingresos (Piketty) {.smaller}

![](img/desigualdad.png){fig-alt='Dos gráficos de líneas sobre desigualdad de ingresos. A la izquierda, la participación del decil superior en el ingreso nacional de EE. UU. entre 1910 y 2010: cae de cerca de 45% en los años 1920 a alrededor de 33% entre 1950 y 1970, y vuelve a subir hasta cerca de 50% en 2010, dibujando una curva en forma de U. A la derecha, la participación del 1%, 0,1% y 0,01% más rico en el ingreso fiscal entre 1964 y 2017: el 1% más rico sube de cerca de 13% a un máximo de 18% hacia 1990 y luego se mantiene entre 15% y 16%.' fig-align="center"}
...
-   La desigualdad es el resultado de políticas e instituciones que cambian históricamente.

## Usos Actuales en Políticas Públicas {.smaller}
...
## Ejercicio Final: Formulen sus Preguntas {.smaller}
...
-   Hemos visto que la estadística es una herramienta fundamental, inserta en un proceso de investigación reflexivo y teóricamente informado. Nos permite traducir conceptos sociológicos en mediciones para descubrir patrones sociales, como lo hizo Durkheim y como se hace hoy en las políticas públicas.

-   La cuantificación no es un acto neutro; implica supuestos ontológicos y teóricos. Un buen sociólogo/a sabe usar los números como herramienta para construir conocimiento sobre la sociedad.
