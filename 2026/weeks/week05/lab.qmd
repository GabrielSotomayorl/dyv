...
*   Importar una base de datos en formato `.RData` usando el paquete `haven`.
...
Encuestas como CASEN son procesadas originalmente en programas como SPSS. Al convertirlas a R, las variables conservan una metadata especial llamada **etiquetas** (por ejemplo, que el código `1` significa *"Hombre"* y el `2` significa *"Mujer"*). El paquete `haven` le enseña a R cómo interpretar esa información. **Sin `haven` cargado, R no sabrá qué hacer con las etiquetas de las variables.**
:::
