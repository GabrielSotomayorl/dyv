...
title: "<font style='font-size:1em;'>🗓️ Semana 03<br/> Conceptos clave para la investigación social I</font>"
...
En la sesión anterior abordamos la estadística como herramienta sociológica:

-   **La cuantificación no es neutra:** medir implica decisiones teóricas sobre qué propiedades de la realidad social son importantes y cómo representarlas numéricamente.
-   **La reflexividad** exige ser conscientes de cómo nuestra posición como investigadores/as afecta las preguntas que hacemos y cómo interpretamos los datos.
-   **Vimos ejemplos concretos:** Durkheim usó tasas de suicidio para hacer visible la integración social; Bourdieu y Piketty usaron datos para argumentar sobre la desigualdad.
-   **Primer contacto con R:** aprendimos a crear objetos y aplicar funciones (`mean()`, `summary()`) para explorar un vector de datos.

**Hoy:** damos el siguiente paso y vemos cómo pasar de un concepto teórico a una variable medible.


# 1. Del Concepto al Indicador

## El Problema: Los Conceptos Sociológicos son Abstractos {.smaller}
...
## Conceptualización: El Proceso de Especificación {.smaller}
...
## Operacionalización: El Puente hacia el Mundo Empírico {.smaller}
...
## El Flujo Completo: De la Idea al Dato {.smaller}
...
## La Jerarquía de la Medición {.smaller}
...
digraph G {
  ...
  // Definición de Nodos
  concepto [label="Concepto\n(Idea abstracta, ej. Bienestar Social)", shape=ellipse, style=filled, fillcolor="#7C90CC", fontcolor=white];
...
## Conceptos Unidimensionales vs. Multidimensionales {.smaller}
...
## Características de un Buen Indicador {.smaller}
...
## Una Pincelada de Calidad: Fiabilidad y Validez {.smaller}
...
## Ejemplo 1: Inseguridad Alimentaria (CASEN - FIES) {.smaller}
...
## Operacionalización de la Inseguridad Alimentaria {.smaller}
...
## Ejemplo 2: Clase Social como Capital Multidimensional {.smaller}
...
## Dimensión 1: Capital Económico {.smaller}
...
## Dimensión 2: Capital Social {.smaller}
...
## Dimensión 3: Capital Cultural {.smaller}
...
## Indicadores del Capital Cultural {.smaller}
...
## Conclusión del Ejemplo: Un Mapa de Clases {.smaller}
...
## La gran calculadora de clases británica {.smaller}

![](img/survey.png){fig-alt='Página promocional de la Great British Class Survey de la BBC: invita a responder cinco preguntas para descubrir a cuál de las siete nuevas clases sociales identificadas pertenece la persona, con ilustraciones de figuras humanas y un código QR de acceso.' fig-align="center"}


# 2. ¿A Quién o Qué Estudiamos?

## La Unidad de Análisis {.smaller}
...
## Unidad de Análisis vs. Unidad de Observación {.smaller}
...
## Las Falacias Lógicas en la Investigación {.smaller}
...
## Actividad de Discusión (10 min) {.smaller}
...
![](img/casen.png){fig-alt='Ficha técnica de la Encuesta CASEN 2022: sus unidades de análisis son las personas y los hogares, mientras que el informante (unidad de observación) es un integrante del hogar de 18 años o más, que responde por todo el hogar.' fig-align="center"}

## {.smaller}

![](img/encla.png){fig-alt='Página de aspectos metodológicos de la Encuesta Laboral (ENCLA) 2023, que describe cómo se aplican distintos cuestionarios según el informante dentro de cada empresa —empleadores/as, sindicatos y trabajadores/as—, cada uno con su propio criterio de selección.' fig-align="center"}



## Ejemplo Sociológico: ¿Cuál es la Unidad de Análisis de la Clase Social? {.smaller}
...
## Críticas Feministas a la Perspectiva Convencional {.smaller}
...
## Hacia una Solución: Posiciones Directas y Mediadas (Wright, 1989) {.smaller}
...
## Modelo de Wright: Efectos sobre la Identidad de Clase {.smaller}
...
## Variables Dependientes e Independientes {.smaller}
...
## Nivel de Medición: NOMINAL {.smaller}
...
## Nivel de Medición: ORDINAL {.smaller}
...
## Nivel de Medición: INTERVALO Y RAZÓN {.smaller}
...
## Tabla Resumen de los Niveles de Medición {.smaller}
...
## Actividad Práctica (15 min) {.smaller}
